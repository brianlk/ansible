...
def add_disk(si):
    ...
    sp = vim.VirtualDiskManager.FileBackedVirtualDiskSpec(adapterType="busLogic",diskType="thick", capacityKb=100000)
    x = vd.CreateVirtualDisk_Task(name="[Datastore] t1/abcdisk1.vmdk", datacenter=datacenter, spec=sp)
    print(x)
